...
- Synthetic workers and reliability tests for healthy work, live-but-stalled work, crashes, escalation, event contracts, and public-telemetry boundaries. The recorded stalled-worker evaluation proves that a live process with stale evidence is detected and recovered.
