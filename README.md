...
- Bounded task handlers can publish a short redacted result note alongside their aggregate metrics, so Research and Activity show what completed without exposing prompts, credentials, paths, or unrestricted model output.
